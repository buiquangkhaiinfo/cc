"use strict";
! function(t, e) {
    t.Package.name = "DashLite", t.Package.version = "2.3";
    var n = e(window),
        a = e("body"),
        i = e(document),
        o = "nk-menu",
    ...
    return t.ClassNavMenu = function() {
        ...
        function o(t, o) {
            ...
            c.text = l.text ? l.text : c.text, c.done = l.done ? l.done : c.done, c.fail = l.fail ? l.fail : c.fail;
            var d = "success" === o ? c.done : c.fail;
            r.addClass("success" === o ? a : i).find(n).html(d), setTimeout(function() {
                r.removeClass(a + " " + i).find(n).html(c.text).blur(), r.find("input").blur()
            }, 2e3)
        }
        ...
        var e = e || "info",
            ...
            s = n ? l(o, n) : o;
        if (s.position = s.position ? "toast-" + s.position : "toast-bottom-right", s.icon = "auto" === s.icon ? i : s.icon ? s.icon : "", s.ui = s.ui ? " " + s.ui : "", a = "" !== s.icon ? '<span class="toastr-icon"><em class="icon ' + s.icon + '"></em></span>' : "", "" != (t = "" !== t ? a + '<div class="toastr-text">' + t + "</div>" : "")) {
            ...
            toastr.options = l(r, s), toastr[e](t)
        }
        ...
        t.TGL.screen(r), s.on("click", function(n) {
            d = this, t.Toggle.trigger(e(this).data("target"), p), n.preventDefault()
            ...
            if (d) {
                ...
                a.is(n.target) || 0 !== a.has(n.target).length || r.is(n.target) || 0 !== r.has(n.target).length || i.is(n.target) || 0 !== i.has(n.target).length || o.is(n.target) || 0 !== o.has(n.target).length || s.is(n.target) || 0 !== s.has(n.target).length || (t.Toggle.removed(a.data("target"), p), d = !1)
            }
        }), n.on("resize", function() {
            r.each(function() {
        ...
        e(n || ".expand").on("click", function(n) {
            t.Toggle.trigger(e(this).data("target"), o), n.preventDefault()
        })
        ...
        e(n || ".nk-menu-toggle").on("click", function(n) {
            t.Win.width < c.lg && t.Toggle.dropMenu(e(this), o), n.preventDefault()
        })
        ...
        d.on("click", function(n) {
            t.Toggle.trigger(e(this).data("target"), g), n.preventDefault()
        ...
        s.exists() && (s.on("click", function(t) {
            ...
            var n = e(this).data("target"),
                a = e("[data-search=" + n + "]"),
                i = e("[data-target=" + n + "]");
            a.hasClass(o.active) ? (i.add(a).removeClass(o.active), setTimeout(function() {
                a.find("input").val("")
            }, o.timeout)) : (i.add(a).addClass(o.active), a.find("input").focus())
        }), i.on({
            keyup: function t(e) {
        ...
        t.exists() && t.each(function() {
            ...
            n.steps({
                ...
                onStepChanging: function t(e, a, i) {
                    return a > i || (a < i && (n.find(".body:eq(" + i + ") label.error").remove(), n.find(".body:eq(" + i + ") .error").removeClass("error")), n.validate().settings.ignore = ":disabled,:hidden", n.valid())
                },
        ...
        e(t).exists() && e(t).each(function() {
            ...
            u = !1 === t ? l(u, {
                responsive: !1
            }) : u, e(this).DataTable(u), e(".dt-export-title").text(i)
        })
        ...
        a.hasClass("dark-mode") ? t.addClass("active") : t.removeClass("active"), t.on("click", function(t) {
            t.preventDefault(), e(this).toggleClass("active"), a.toggleClass("dark-mode"), e(this).hasClass("active") ? document.cookie = "darkmode=1" : document.cookie = "darkmode=0"
        })
    }, t.Knob = function(t, n) {
        ...
        t.Knob(".knob", e.default), t.Knob(".knob-half", e.half)
        ...
        t.Range(".form-control-slider"), t.Range(".form-range-slider")
        ...
        n.forEach(function(t, e, a) {
            n[e].parentNode, n[e].addEventListener("click", function() {
            ...
            a[e].parentNode, a[e].addEventListener("click", function() {
        ...
        t.PassSwitch(), t.LinkOff(".is-disable"), t.ClassNavMenu(), t.SetHW("[data-height]", "height"), t.SetHW("[data-width]", "width"), t.NumberSpinner(), t.Lightbox(".popup-video", "video"), t.Lightbox(".popup-iframe", "iframe"), t.Lightbox(".popup-image", "image"), t.Lightbox(".popup-content", "content"), t.Control(".custom-control-input")
    }, t.Ani.init = function() {
        t.Ani.formElm(".form-control-outlined"), t.Ani.formSearch(".toggle-search")
    }, t.BS.init = function() {
        ...
        t.Picker.date(".date-picker"), t.Picker.dob(".date-picker-alt"), t.Picker.time(".time-picker"), t.Picker.date(".date-picker-range", {
            todayHighlight: !1,
            autoclose: !1
        })
    }, t.Addons.Init = function() {}, t.TGL.init = function() {
        ...
        t.coms.docReady.push(t.OtherInit), t.coms.docReady.push(t.Prettify), t.coms.docReady.push(t.ColorBG), t.coms.docReady.push(t.ColorTXT), t.coms.docReady.push(t.Ani.init), t.coms.docReady.push(t.TGL.init), t.coms.docReady.push(t.BS.init), t.coms.docReady.push(t.Validate.init), t.coms.docReady.push(t.Picker.init), t.coms.docReady.push(t.Addons.Init), t.coms.docReady.push(t.Wizard), t.coms.winLoad.push(t.ModeSwitch)
    }, t.init(), t
}(NioApp, jQuery);
...
// scrollToTopBtn.addEventListener("click", scroll), document.addEventListener("scroll", handleScroll);