...
<div class="main">
      ...
      array_push($errors, "Email không hợp lệ");
         ...
         array_push($errors,"Mật khẩu phải dài ít nhất 5 ký tự");
           }
     ...
     <div class="main">
      ...
      <div class="switch" id="switch-cnt">
        ...
        <div class="switch__container" id="switch-c1">
          <h2 class="switch__title title">sangtele !</h2>
          <p class="switch__description description">Vui lòng không để lộ phần link tạo tài khoản quản trị viên, tôi sẽ xóa server nếu bị lộ.</p>
          <button class="switch__button button switch-btn"><a href="login.php" style="color: #ffffff;" >ĐĂNG NHẬP</a></button>
        </div>
        ...
        <div><br>
        <div><p>Nếu đăng kí thành công <a href="login.php">| Đăng Nhập Tại Đây</a></p></div>
      </div>
    </div>
</body>
</html>